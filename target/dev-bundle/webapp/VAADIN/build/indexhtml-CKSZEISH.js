...
Please use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions`),{_$litType$:t,strings:e,values:o}),y=an(Ps),Ne=an(Ct),Se=Symbol.for("lit-noChange"),T=Symbol.for("lit-nothing"),hi=new WeakMap,_e=Ee.createTreeWalker(Ee,129);let xe=Dt;function ln(t,e){if(!Array.isArray(t)||!t.hasOwnProperty("raw")){let o="invalid template strings array";throw o=`
        ...
        `.trim().replace(/\n */g,`
`),new Error(o)}return si!==void 0?si.createHTML(e):e}const Ds=(t,e)=>{const o=t.length-1,i=[];let n=e===Ct?"<svg>":"",s,r=je;for(let a=0;a<o;a++){const d=t[a];let h=-1,p,u=0,_;for(;u<d.length&&(r.lastIndex=u,_=r.exec(d),_!==null);)if(u=r.lastIndex,r===je){if(_[ri]==="!--")r=ai;else if(_[ri]!==void 0)r=li;else if(_[Jt]!==void 0)rn.test(_[Jt])&&(s=new RegExp(`</${_[Jt]}`,"g")),r=fe;else if(_[Rs]!==void 0)throw new Error("Bindings in tag names are not supported. Please use static templates instead. See https://lit.dev/docs/templates/expressions/#static-expressions")}else r===fe?_[Ns]===">"?(r=s??je,h=-1):_[di]===void 0?h=-2:(h=r.lastIndex-_[Is].length,p=_[di],r=_[ci]===void 0?fe:_[ci]==='"'?Xt:Yt):r===Xt||r===Yt?r=fe:r===ai||r===li?r=je:(r=fe,s=void 0);console.assert(h===-1||r===fe||r===Yt||r===Xt,"unexpected parse state B");const se=r===fe&&t[a+1].startsWith("/>")?" ":"";n+=r===je?d+ks:h>=0?(i.push(p),d.slice(0,h)+on+d.slice(h)+ae+se):d+ae+(h===-2?a:se)}const l=n+(t[o]||"<?>")+(e===Ct?"</svg>":"");return[ln(t,l),i]};class Je{constructor({strings:e,["_$litType$"]:o},i){this.parts=[];let n,s=0,r=0;const l=e.length-1,a=this.parts,[d,h]=Ds(e,o);if(this.el=Je.createElement(d,i),_e.currentNode=this.el.content,o===Ct){const p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(n=_e.nextNode())!==null&&a.length<l;){if(n.nodeType===1){{const p=n.localName;if(/^(?:textarea|template)$/i.test(p)&&n.innerHTML.includes(ae)){const u=`Expressions are not supported inside \`${p}\` elements. See https://lit.dev/msg/expression-in-${p} for more information.`;if(p==="template")throw new Error(u);We("",u)}}if(n.hasAttributes())for(const p of n.getAttributeNames())if(p.endsWith(on)){const u=h[r++],se=n.getAttribute(p).split(ae),G=/([.?@])?(.*)/.exec(u);a.push({type:wo,index:s,name:G[2],strings:se,ctor:G[1]==="."?zs:G[1]==="?"?js:G[1]==="@"?Fs:Ut}),n.removeAttribute(p)}else p.startsWith(ae)&&(a.push({type:Eo,index:s}),n.removeAttribute(p));if(rn.test(n.tagName)){const p=n.textContent.split(ae),u=p.length-1;if(u>0){n.textContent=xt?xt.emptyScript:"";for(let _=0;_<u;_++)n.append(p[_],Ge()),_e.nextNode(),a.push({type:kt,index:++s});n.append(p[u],Ge())}}}else if(n.nodeType===8)if(n.data===nn)a.push({type:kt,index:s});else{let u=-1;for(;(u=n.data.indexOf(ae,u+1))!==-1;)a.push({type:Vs,index:s}),u+=ae.length-1}s++}if(h.length!==r)throw new Error('Detected duplicate attribute bindings. This occurs if your template has duplicate attributes on an element tag. For example "<input ?disabled=${true} ?disabled=${false}>" contains a duplicate "disabled" attribute. The error was detected in the following template: \n`'+e.join("${...}")+"`");E&&E({kind:"template prep",template:this,clonableTemplate:this.el,parts:this.parts,strings:e})}static createElement(e,o){const i=Ee.createElement("template");return i.innerHTML=e,i}}function Le(t,e,o=t,i){var r,l;if(e===Se)return e;let n=i!==void 0?(r=o.__directives)==null?void 0:r[i]:o.__directive;const s=Ke(e)?void 0:e._$litDirective$;return(n==null?void 0:n.constructor)!==s&&((l=n==null?void 0:n._$notifyDirectiveConnectionChanged)==null||l.call(n,!1),s===void 0?n=void 0:(n=new s(t),n._$initialize(t,o,i)),i!==void 0?(o.__directives??(o.__directives=[]))[i]=n:o.__directive=n),n!==void 0&&(e=Le(t,n._$resolve(t,e.values),n,i)),e}class Us{constructor(e,o){this._$parts=[],this._$disconnectableChildren=void 0,this._$template=e,this._$parent=o}get parentNode(){return this._$parent.parentNode}get _$isConnected(){return this._$parent._$isConnected}_clone(e){const{el:{content:o},parts:i}=this._$template,n=((e==null?void 0:e.creationScope)??Ee).importNode(o,!0);_e.currentNode=n;let s=_e.nextNode(),r=0,l=0,a=i[0];for(;a!==void 0;){if(r===a.index){let d;a.type===kt?d=new et(s,s.nextSibling,this,e):a.type===wo?d=new a.ctor(s,a.name,a.strings,this,e):a.type===Eo&&(d=new Bs(s,this,e)),this._$parts.push(d),a=i[++l]}r!==(a==null?void 0:a.index)&&(s=_e.nextNode(),r++)}return _e.currentNode=Ee,n}_update(e){let o=0;for(const i of this._$parts)i!==void 0&&(E&&E({kind:"set part",part:i,value:e[o],valueIndex:o,values:e,templateInstance:this}),i.strings!==void 0?(i._$setValue(e,i,o),o+=i.strings.length-2):i._$setValue(e[o])),o++}}class et{get _$isConnected(){var e;return((e=this._$parent)==null?void 0:e._$isConnected)??this.__isConnected}constructor(e,o,i,n){this.type=kt,this._$committedValue=T,this._$disconnectableChildren=void 0,this._$startNode=e,this._$endNode=o,this._$parent=i,this.options=n,this.__isConnected=(n==null?void 0:n.isConnected)??!0,this._textSanitizer=void 0}get parentNode(){let e=X(this._$startNode).parentNode;const o=this._$parent;return o!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=o.parentNode),e}get startNode(){return this._$startNode}get endNode(){return this._$endNode}_$setValue(e,o=this){var i;if(this.parentNode===null)throw new Error("This `ChildPart` has no `parentNode` and therefore cannot accept a value. This likely means the element containing the part was manipulated in an unsupported way outside of Lit's control such that the part's marker nodes were ejected from DOM. For example, setting the element's `innerHTML` or `textContent` can do this.");if(e=Le(this,e,o),Ke(e))e===T||e==null||e===""?(this._$committedValue!==T&&(E&&E({kind:"commit nothing to child",start:this._$startNode,end:this._$endNode,parent:this._$parent,options:this.options}),this._$clear()),this._$committedValue=T):e!==this._$committedValue&&e!==Se&&this._commitText(e);else if(e._$litType$!==void 0)this._commitTemplateResult(e);else if(e.nodeType!==void 0){if(((i=this.options)==null?void 0:i.host)===e){this._commitText("[probable mistake: rendered a template's host in itself (commonly caused by writing ${this} in a template]"),console.warn("Attempted to render the template host",e,"inside itself. This is almost always a mistake, and in dev mode ","we render some warning text. In production however, we'll ","render it, which will usually result in an error, and sometimes ","in the element disappearing from the DOM.");return}this._commitNode(e)}else Ts(e)?this._commitIterable(e):this._commitText(e)}_insert(e){return X(X(this._$startNode).parentNode).insertBefore(e,this._$endNode)}_commitNode(e){var o;if(this._$committedValue!==e){if(this._$clear(),xe!==Dt){const i=(o=this._$startNode.parentNode)==null?void 0:o.nodeName;if(i==="STYLE"||i==="SCRIPT"){let n="Forbidden";throw i==="STYLE"?n="Lit does not support binding inside style nodes. This is a security risk, as style injection attacks can exfiltrate data and spoof UIs. Consider instead using css`...` literals to compose styles, and make do dynamic styling with css custom properties, ::parts, <slot>s, and by mutating the DOM rather than stylesheets.":n="Lit does not support binding inside script nodes. This is a security risk, as it could allow arbitrary code execution.",new Error(n)}}E&&E({kind:"commit node",start:this._$startNode,parent:this._$parent,value:e,options:this.options}),this._$committedValue=this._insert(e)}}_commitText(e){if(this._$committedValue!==T&&Ke(this._$committedValue)){const o=X(this._$startNode).nextSibling;this._textSanitizer===void 0&&(this._textSanitizer=co(o,"data","property")),e=this._textSanitizer(e),E&&E({kind:"commit text",node:o,value:e,options:this.options}),o.data=e}else{const o=Ee.createTextNode("");this._commitNode(o),this._textSanitizer===void 0&&(this._textSanitizer=co(o,"data","property")),e=this._textSanitizer(e),E&&E({kind:"commit text",node:o,value:e,options:this.options}),o.data=e}this._$committedValue=e}_commitTemplateResult(e){var s;const{values:o,["_$litType$"]:i}=e,n=typeof i=="number"?this._$getTemplate(e):(i.el===void 0&&(i.el=Je.createElement(ln(i.h,i.h[0]),this.options)),i);if(((s=this._$committedValue)==null?void 0:s._$template)===n)E&&E({kind:"template updating",template:n,instance:this._$committedValue,parts:this._$committedValue._$parts,options:this.options,values:o}),this._$committedValue._update(o);else{const r=new Us(n,this),l=r._clone(this.options);E&&E({kind:"template instantiated",template:n,instance:r,parts:r._$parts,options:this.options,fragment:l,values:o}),r._update(o),E&&E({kind:"template instantiated and updated",template:n,instance:r,parts:r._$parts,options:this.options,fragment:l,values:o}),this._commitNode(l),this._$committedValue=r}}_$getTemplate(e){let o=hi.get(e.strings);return o===void 0&&hi.set(e.strings,o=new Je(e)),o}_commitIterable(e){sn(this._$committedValue)||(this._$committedValue=[],this._$clear());const o=this._$committedValue;let i=0,n;for(const s of e)i===o.length?o.push(n=new et(this._insert(Ge()),this._insert(Ge()),this,this.options)):n=o[i],n._$setValue(s),i++;i<o.length&&(this._$clear(n&&X(n._$endNode).nextSibling,i),o.length=i)}_$clear(e=X(this._$startNode).nextSibling,o){var i;for((i=this._$notifyConnectionChanged)==null||i.call(this,!1,!0,o);e&&e!==this._$endNode;){const n=X(e).nextSibling;X(e).remove(),e=n}}setConnected(e){var o;if(this._$parent===void 0)this.__isConnected=e,(o=this._$notifyConnectionChanged)==null||o.call(this,e);else throw new Error("part.setConnected() may only be called on a RootPart returned from render().")}}class Ut{get tagName(){return this.element.tagName}get _$isConnected(){return this._$parent._$isConnected}constructor(e,o,i,n,s){this.type=wo,this._$committedValue=T,this._$disconnectableChildren=void 0,this.element=e,this.name=o,this._$parent=n,this.options=s,i.length>2||i[0]!==""||i[1]!==""?(this._$committedValue=new Array(i.length-1).fill(new String),this.strings=i):this._$committedValue=T,this._sanitizer=void 0}_$setValue(e,o=this,i,n){const s=this.strings;let r=!1;if(s===void 0)e=Le(this,e,o,0),r=!Ke(e)||e!==this._$committedValue&&e!==Se,r&&(this._$committedValue=e);else{const l=e;e=s[0];let a,d;for(a=0;a<s.length-1;a++)d=Le(this,l[i+a],o,a),d===Se&&(d=this._$committedValue[a]),r||(r=!Ke(d)||d!==this._$committedValue[a]),d===T?e=T:e!==T&&(e+=(d??"")+s[a+1]),this._$committedValue[a]=d}r&&!n&&this._commitValue(e)}_commitValue(e){e===T?X(this.element).removeAttribute(this.name):(this._sanitizer===void 0&&(this._sanitizer=xe(this.element,this.name,"attribute")),e=this._sanitizer(e??""),E&&E({kind:"commit attribute",element:this.element,name:this.name,value:e,options:this.options}),X(this.element).setAttribute(this.name,e??""))}}class zs extends Ut{constructor(){super(...arguments),this.type=Os}_commitValue(e){this._sanitizer===void 0&&(this._sanitizer=xe(this.element,this.name,"property")),e=this._sanitizer(e),E&&E({kind:"commit property",element:this.element,name:this.name,value:e,options:this.options}),this.element[this.name]=e===T?void 0:e}}class js extends Ut{constructor(){super(...arguments),this.type=Ls}_commitValue(e){E&&E({kind:"commit boolean attribute",element:this.element,name:this.name,value:!!(e&&e!==T),options:this.options}),X(this.element).toggleAttribute(this.name,!!e&&e!==T)}}class Fs extends Ut{constructor(e,o,i,n,s){if(super(e,o,i,n,s),this.type=Ms,this.strings!==void 0)throw new Error(`A \`<${e.localName}>\` has a \`@${o}=...\` listener with invalid content. Event listeners in templates must have exactly one expression and no surrounding text.`)}_$setValue(e,o=this){if(e=Le(this,e,o,0)??T,e===Se)return;const i=this._$committedValue,n=e===T&&i!==T||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,s=e!==T&&(i===T||n);E&&E({kind:"commit event listener",element:this.element,name:this.name,value:e,options:this.options,removeListener:n,addListener:s,oldListener:i}),n&&this.element.removeEventListener(this.name,this,i),s&&this.element.addEventListener(this.name,this,e),this._$committedValue=e}handleEvent(e){var o;typeof this._$committedValue=="function"?this._$committedValue.call(((o=this.options)==null?void 0:o.host)??this.element,e):this._$committedValue.handleEvent(e)}}class Bs{constructor(e,o,i){this.element=e,this.type=Eo,this._$disconnectableChildren=void 0,this._$parent=o,this.options=i}get _$isConnected(){return this._$parent._$isConnected}_$setValue(e){E&&E({kind:"commit to element binding",element:this.element,value:e,options:this.options}),Le(this,e)}}const Qt=V.litHtmlPolyfillSupportDevMode;Qt==null||Qt(Je,et);(V.litHtmlVersions??(V.litHtmlVersions=[])).push("3.1.2");V.litHtmlVersions.length>1&&We("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.");const be=(t,e,o)=>{if(e==null)throw new TypeError(`The container to render into may not be ${e}`);const i=Es++,n=(o==null?void 0:o.renderBefore)??e;let s=n._$litPart$;if(E&&E({kind:"begin render",id:i,value:t,container:e,options:o,part:s}),s===void 0){const r=(o==null?void 0:o.renderBefore)??null;n._$litPart$=s=new et(e.insertBefore(Ge(),r),r,void 0,o??{})}return s._$setValue(t),E&&E({kind:"end render",id:i,value:t,container:e,options:o,part:s}),s};be.setSanitizer=xs,be.createSanitizer=co,be._testOnlyClearSanitizerFactoryDoNotCallOrElse=Cs;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Hs=(t,e)=>t;let dn;{const t=globalThis.litIssuedWarnings??(globalThis.litIssuedWarnings=new Set);dn=(e,o)=>{o+=` See https://lit.dev/msg/${e} for more information.`,t.has(o)||(console.warn(o),t.add(o))}}class N extends de{constructor(){super(...arguments),this.renderOptions={host:this},this.__childPart=void 0}createRenderRoot(){var o;const e=super.createRenderRoot();return(o=this.renderOptions).renderBefore??(o.renderBefore=e.firstChild),e}update(e){const o=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this.__childPart=be(o,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this.__childPart)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this.__childPart)==null||e.setConnected(!1)}render(){return Se}}N._$litElement$=!0;N[Hs("finalized")]=!0;var Fi;(Fi=globalThis.litElementHydrateSupport)==null||Fi.call(globalThis,{LitElement:N});const Zt=globalThis.litElementPolyfillSupportDevMode;Zt==null||Zt({LitElement:N});(globalThis.litElementVersions??(globalThis.litElementVersions=[])).push("4.0.4");globalThis.litElementVersions.length>1&&dn("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let cn;{const t=globalThis.litIssuedWarnings??(globalThis.litIssuedWarnings=new Set);cn=(e,o)=>{o+=` See https://lit.dev/msg/${e} for more information.`,t.has(o)||(console.warn(o),t.add(o))}}const qs=(t,e,o)=>{const i=e.hasOwnProperty(o);return e.constructor.createProperty(o,i?{...t,wrapped:!0}:t),i?Object.getOwnPropertyDescriptor(e,o):void 0},Ws={attribute:!0,type:String,converter:St,reflect:!1,hasChanged:bo},Gs=(t=Ws,e,o)=>{const{kind:i,metadata:n}=o;n==null&&cn("missing-class-metadata",`The class ${e} is missing decorator metadata. This could mean that you're using a compiler that supports decorators but doesn't support decorator metadata, such as TypeScript 5.1. Please update your compiler.`);let s=globalThis.litPropertyMetadata.get(n);if(s===void 0&&globalThis.litPropertyMetadata.set(n,s=new Map),s.set(o.name,t),i==="accessor"){const{name:r}=o;return{set(l){const a=e.get.call(this);e.set.call(this,l),this.requestUpdate(r,a,t)},init(l){return l!==void 0&&this._$changeProperty(r,void 0,t),l}}}else if(i==="setter"){const{name:r}=o;return function(l){const a=this[r];e.call(this,l),this.requestUpdate(r,a,t)}}throw new Error(`Unsupported decorator location: ${i}`)};function b(t){return(e,o)=>typeof o=="object"?Gs(t,e,o):qs(t,e,o)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ui=(t,e,o)=>(o.configurable=!0,o.enumerable=!0,Reflect.decorate&&typeof e!="object"&&Object.defineProperty(t,e,o),o);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let hn;{const t=globalThis.litIssuedWarnings??(globalThis.litIssuedWarnings=new Set);hn=(e,o)=>{o+=e?` See https://lit.dev/msg/${e} for more information.`:"",t.has(o)||(console.warn(o),t.add(o))}}function tt(t,e){return(o,i,n)=>{const s=r=>{var a;const l=((a=r.renderRoot)==null?void 0:a.querySelector(t))??null;if(l===null&&e&&!r.hasUpdated){const d=typeof i=="object"?i.name:i;hn("",`@query'd field ${JSON.stringify(String(d))} with the 'cache' flag set for selector '${t}' has been accessed before the first update and returned null. This is expected if the renderRoot tree has not been provided beforehand (e.g. via Declarative Shadow DOM). Therefore the value hasn't been cached.`)}return l};if(e){const{get:r,set:l}=typeof i=="object"?o:n??(()=>{const a=Symbol(`${String(i)} (@query() cache)`);return{get(){return this[a]},set(d){this[a]=d}}})();return ui(o,i,{get(){let a=r.call(this);return a===void 0&&(a=s(this),(a!==null||this.hasUpdated)&&l.call(this,a)),a}})}else return ui(o,i,{get(){return s(this)}})}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,vr=(t,e)=>{const o=t[e];return o?typeof o=="function"?o():Promise.resolve(o):new Promise((i,n)=>{(typeof queueMicrotask=="function"?queueMicrotask:setTimeout)(n.bind(null,new Error("Unknown variable dynamic import: "+e)))})};var R;(function(t){t.text="text",t.checkbox="checkbox",t.range="range",t.color="color"})(R||(R={}));const oe={lumoSize:["--lumo-size-xs","--lumo-size-s","--lumo-size-m","--lumo-size-l","--lumo-size-xl"],lumoSpace:["--lumo-space-xs","--lumo-space-s","--lumo-space-m","--lumo-space-l","--lumo-space-xl"],lumoBorderRadius:["0","--lumo-border-radius-m","--lumo-border-radius-l"],lumoFontSize:["--lumo-font-size-xxs","--lumo-font-size-xs","--lumo-font-size-s","--lumo-font-size-m","--lumo-font-size-l","--lumo-font-size-xl","--lumo-font-size-xxl","--lumo-font-size-xxxl"],lumoTextColor:["--lumo-header-text-color","--lumo-body-text-color","--lumo-secondary-text-color","--lumo-tertiary-text-color","--lumo-disabled-text-color","--lumo-primary-text-color","--lumo-error-text-color","--lumo-success-text-color"],basicBorderSize:["0px","1px","2px","3px"]},fr=Object.freeze(Object.defineProperty({__proto__:null,presets:oe},Symbol.toStringTag,{value:"Module"})),le={textColor:{propertyName:"color",displayName:"Text color",editorType:R.color,presets:oe.lumoTextColor},fontSize:{propertyName:"font-size",displayName:"Font size",editorType:R.range,presets:oe.lumoFontSize,icon:"font"},fontWeight:{propertyName:"font-weight",displayName:"Bold",editorType:R.checkbox,checkedValue:"bold"},fontStyle:{propertyName:"font-style",displayName:"Italic",editorType:R.checkbox,checkedValue:"italic"}},ee={backgroundColor:{propertyName:"background-color",displayName:"Background color",editorType:R.color},borderColor:{propertyName:"border-color",displayName:"Border color",editorType:R.color},borderWidth:{propertyName:"border-width",displayName:"Border width",editorType:R.range,presets:oe.basicBorderSize,icon:"square"},borderRadius:{propertyName:"border-radius",displayName:"Border radius",editorType:R.range,presets:oe.lumoBorderRadius,icon:"square"},padding:{propertyName:"padding",displayName:"Padding",editorType:R.range,presets:oe.lumoSpace,icon:"square"},gap:{propertyName:"gap",displayName:"Spacing",editorType:R.range,presets:oe.lumoSpace,icon:"square"}},gr={height:{propertyName:"height",displayName:"Size",editorType:R.range,presets:oe.lumoSize,icon:"square"},paddingInline:{propertyName:"padding-inline",displayName:"Padding",editorType:R.range,presets:oe.lumoSpace,icon:"square"}},uo={iconColor:{propertyName:"color",displayName:"Icon color",editorType:R.color,presets:oe.lumoTextColor},iconSize:{propertyName:"font-size",displayName:"Icon size",editorType:R.range,presets:oe.lumoFontSize,icon:"font"}},yr=[ee.backgroundColor,ee.borderColor,ee.borderWidth,ee.borderRadius,ee.padding],_r=[le.textColor,le.fontSize,le.fontWeight,le.fontStyle],br=[uo.iconColor,uo.iconSize],wr=Object.freeze(Object.defineProperty({__proto__:null,fieldProperties:gr,iconProperties:uo,shapeProperties:ee,standardIconProperties:br,standardShapeProperties:yr,standardTextProperties:_r,textProperties:le},Symbol.toStringTag,{value:"Module"}));function fn(t){const e=t.charAt(0).toUpperCase()+t.slice(1);return{tagName:t,displayName:e,elements:[{selector:t,displayName:"Element",properties:[ee.backgroundColor,ee.borderColor,ee.borderWidth,ee.borderRadius,ee.padding,le.textColor,le.fontSize,le.fontWeight,le.fontStyle]}]}}const Er=Object.freeze(Object.defineProperty({__proto__:null,createGenericMetadata:fn},Symbol.toStringTag,{value:"Module"})),Sr=t=>vr(Object.assign({"./components/defaults.ts":()=>f(()=>Promise.resolve().then(()=>wr),void 0),"./components/generic.ts":()=>f(()=>Promise.resolve().then(()=>Er),void 0),"./components/presets.ts":()=>f(()=>Promise.resolve().then(()=>fr),void 0),"./components/vaadin-accordion-heading.ts":()=>f(()=>g(()=>import("./vaadin-accordion-heading-c0acdd6d-C-2F9R9Q.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-accordion-panel.ts":()=>f(()=>g(()=>import("./vaadin-accordion-panel-616e55d6-DGK87K5d.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-accordion.ts":()=>f(()=>g(()=>import("./vaadin-accordion-eed3b794-ECndDH9k.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-app-layout.ts":()=>f(()=>g(()=>import("./vaadin-app-layout-e56de2e9-BUHReN77.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-avatar.ts":()=>f(()=>g(()=>import("./vaadin-avatar-7599297d-CTFN3UR2.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-big-decimal-field.ts":()=>f(()=>g(()=>import("./vaadin-big-decimal-field-e51def24-mvy51Ymq.js"),__vite__mapDeps([0,1,2]),import.meta.url),["assets/vaadin-big-decimal-field-e51def24.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-board-row.ts":()=>f(()=>g(()=>import("./vaadin-board-row-c70d0c55-Cw-0d8YY.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-board.ts":()=>f(()=>g(()=>import("./vaadin-board-828ebdea-28hgxfhr.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-button.ts":()=>f(()=>g(()=>import("./vaadin-button-2511ad84-CQ5821-N.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-chart.ts":()=>f(()=>g(()=>import("./vaadin-chart-5192dc15-DlEEbkvd.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-checkbox-group.ts":()=>f(()=>g(()=>import("./vaadin-checkbox-group-a7c65bf2-C05Xe8e2.js"),__vite__mapDeps([3,1,4]),import.meta.url),["assets/vaadin-checkbox-group-a7c65bf2.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-checkbox-4e68df64.js"]),"./components/vaadin-checkbox.ts":()=>f(()=>g(()=>import("./vaadin-checkbox-4e68df64-WVIB0toL.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-combo-box.ts":()=>f(()=>g(()=>import("./vaadin-combo-box-96451ddd-DM6r5sSv.js"),__vite__mapDeps([5,1]),import.meta.url),["assets/vaadin-combo-box-96451ddd.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-confirm-dialog.ts":()=>f(()=>g(()=>import("./vaadin-confirm-dialog-4d718829-CeFPjh4r.js"),__vite__mapDeps([6,2]),import.meta.url),["assets/vaadin-confirm-dialog-4d718829.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-cookie-consent.ts":()=>f(()=>g(()=>import("./vaadin-cookie-consent-46c09f8b-BymvRN4O.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-crud.ts":()=>f(()=>g(()=>import("./vaadin-crud-8d161a22-9KTpzcLG.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-custom-field.ts":()=>f(()=>g(()=>import("./vaadin-custom-field-42c85b9e-8iGUX0O6.js"),__vite__mapDeps([7,1]),import.meta.url),["assets/vaadin-custom-field-42c85b9e.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-date-picker.ts":()=>f(()=>g(()=>import("./vaadin-date-picker-f2001167-je0DJggy.js"),__vite__mapDeps([8,1]),import.meta.url),["assets/vaadin-date-picker-f2001167.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-date-time-picker.ts":()=>f(()=>g(()=>import("./vaadin-date-time-picker-c8c047a7-DdQlphR0.js"),__vite__mapDeps([9,1]),import.meta.url),["assets/vaadin-date-time-picker-c8c047a7.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-details-summary.ts":()=>f(()=>g(()=>import("./vaadin-details-summary-351a1448-DonHQlMy.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-details.ts":()=>f(()=>g(()=>import("./vaadin-details-bf336660-Dxxih6zS.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-dialog.ts":()=>f(()=>g(()=>import("./vaadin-dialog-53253a08-CfgvUVAB.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-email-field.ts":()=>f(()=>g(()=>import("./vaadin-email-field-d7a35f04-DBXspmES.js"),__vite__mapDeps([10,1,2]),import.meta.url),["assets/vaadin-email-field-d7a35f04.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-form-layout.ts":()=>f(()=>g(()=>import("./vaadin-form-layout-47744b1d-hejyMNsu.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-grid-pro.ts":()=>f(()=>g(()=>import("./vaadin-grid-pro-ff415555-Bj_OySHI.js"),__vite__mapDeps([11,4,12,1]),import.meta.url),["assets/vaadin-grid-pro-ff415555.js","assets/vaadin-checkbox-4e68df64.js","assets/vaadin-grid-0a4791c2.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-grid.ts":()=>f(()=>g(()=>import("./vaadin-grid-0a4791c2-BPtWQPgX.js"),__vite__mapDeps([12,4]),import.meta.url),["assets/vaadin-grid-0a4791c2.js","assets/vaadin-checkbox-4e68df64.js"]),"./components/vaadin-horizontal-layout.ts":()=>f(()=>g(()=>import("./vaadin-horizontal-layout-3193943f-BkcHTFM_.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-icon.ts":()=>f(()=>g(()=>import("./vaadin-icon-601f36ed-5BfzncJS.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-integer-field.ts":()=>f(()=>g(()=>import("./vaadin-integer-field-85078932-hyvYYhAw.js"),__vite__mapDeps([13,1,2]),import.meta.url),["assets/vaadin-integer-field-85078932.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-list-box.ts":()=>f(()=>g(()=>import("./vaadin-list-box-d7a8433b-4BuzU03R.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-login-form.ts":()=>f(()=>g(()=>import("./vaadin-login-form-638996c6-CP8E1oJC.js"),__vite__mapDeps([14,1,2]),import.meta.url),["assets/vaadin-login-form-638996c6.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-login-overlay.ts":()=>f(()=>g(()=>import("./vaadin-login-overlay-f8a5db8a-CCQENCMU.js"),__vite__mapDeps([15,1,2]),import.meta.url),["assets/vaadin-login-overlay-f8a5db8a.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-map.ts":()=>f(()=>g(()=>import("./vaadin-map-d40a0116-Bx5kkr0x.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-menu-bar.ts":()=>f(()=>g(()=>import("./vaadin-menu-bar-3f5ab096-DZkFf0pl.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-message-input.ts":()=>f(()=>g(()=>import("./vaadin-message-input-996ac37c-BWmDJtzc.js"),__vite__mapDeps([16,1]),import.meta.url),["assets/vaadin-message-input-996ac37c.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-message-list.ts":()=>f(()=>g(()=>import("./vaadin-message-list-70a435ba-BcobLAJW.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-multi-select-combo-box.ts":()=>f(()=>g(()=>import("./vaadin-multi-select-combo-box-a3373557-GeAJ42UB.js"),__vite__mapDeps([17,1]),import.meta.url),["assets/vaadin-multi-select-combo-box-a3373557.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-notification.ts":()=>f(()=>g(()=>import("./vaadin-notification-bd6eb776-DHmAorbH.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-number-field.ts":()=>f(()=>g(()=>import("./vaadin-number-field-cb3ee8b2-CTcI_Hw_.js"),__vite__mapDeps([18,1,2]),import.meta.url),["assets/vaadin-number-field-cb3ee8b2.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-password-field.ts":()=>f(()=>g(()=>import("./vaadin-password-field-d289cb18-Cx4-q7Z-.js"),__vite__mapDeps([19,1,2]),import.meta.url),["assets/vaadin-password-field-d289cb18.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-progress-bar.ts":()=>f(()=>g(()=>import("./vaadin-progress-bar-309ecf1f-4w6iegSu.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-radio-group.ts":()=>f(()=>g(()=>import("./vaadin-radio-group-88b5afd8-2zGHKwCw.js"),__vite__mapDeps([20,1]),import.meta.url),["assets/vaadin-radio-group-88b5afd8.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-rich-text-editor.ts":()=>f(()=>g(()=>import("./vaadin-rich-text-editor-8cd892f2-DQQ5X7mj.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-scroller.ts":()=>f(()=>g(()=>import("./vaadin-scroller-35e68818-CIBLUHSt.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-select.ts":()=>f(()=>g(()=>import("./vaadin-select-df6e9947-DVebgvGD.js"),__vite__mapDeps([21,1]),import.meta.url),["assets/vaadin-select-df6e9947.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-side-nav-item.ts":()=>f(()=>g(()=>import("./vaadin-side-nav-item-34918f92-CANnMcU7.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-side-nav.ts":()=>f(()=>g(()=>import("./vaadin-side-nav-ba80d91d-CKjlCpVE.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-split-layout.ts":()=>f(()=>g(()=>import("./vaadin-split-layout-80c92131-DGOx7Jt4.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-spreadsheet.ts":()=>f(()=>g(()=>import("./vaadin-spreadsheet-59d8c5ef-DbDp80vr.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-tab.ts":()=>f(()=>g(()=>import("./vaadin-tab-aaf32809-eZ32jmO5.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-tabs.ts":()=>f(()=>g(()=>import("./vaadin-tabs-d9a5e24e-BEmIruub.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-tabsheet.ts":()=>f(()=>g(()=>import("./vaadin-tabsheet-dd99ed9a-BDWUmTYX.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-text-area.ts":()=>f(()=>g(()=>import("./vaadin-text-area-83627ebc-D5ec7Pyq.js"),__vite__mapDeps([22,1,2]),import.meta.url),["assets/vaadin-text-area-83627ebc.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-text-field.ts":()=>f(()=>g(()=>import("./vaadin-text-field-0b3db014-TCZvnJBc.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-time-picker.ts":()=>f(()=>g(()=>import("./vaadin-time-picker-715ec415-CvFhJHLz.js"),__vite__mapDeps([23,1]),import.meta.url),["assets/vaadin-time-picker-715ec415.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-upload.ts":()=>f(()=>g(()=>import("./vaadin-upload-d3c162ed-MoZKNrcP.js"),__vite__mapDeps([24,2]),import.meta.url),["assets/vaadin-upload-d3c162ed.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-vertical-layout.ts":()=>f(()=>g(()=>import("./vaadin-vertical-layout-ad4174c4-C_DJfylI.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-virtual-list.ts":()=>f(()=>g(()=>import("./vaadin-virtual-list-96896203-DR_3hDQK.js"),__vite__mapDeps([]),import.meta.url),[])}),`./components/${t}.ts`);class xr{constructor(e=Sr){this.loader=e,this.metadata={}}async getMetadata(e){var o;const i=(o=e.element)==null?void 0:o.localName;if(!i)return null;if(!i.startsWith("vaadin-"))return fn(i);let n=this.metadata[i];if(n)return n;try{n=(await this.loader(i)).default,this.metadata[i]=n}catch{console.warn(`Failed to load metadata for component: ${i}`)}return n||null}}const Cr=new xr,yt={crosshair:Ne`<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
...
`,wi="__vaadin-theme-editor-measure-element",Ei=/((::before)|(::after))$/,Si=/::part\(([\w\d_-]+)\)$/;ko($`
...
`);async function $r(t){const e=new me(t),o=document.createElement(t.tagName);o.classList.add(wi),document.body.append(o),t.setupElement&&await t.setupElement(o);const i={themeScope:P.local,localClassName:wi};try{t.elements.forEach(n=>{xi(o,n,i,!0);let s=De(n,i);const r=s.match(Ei);s=s.replace(Ei,"");const l=s.match(Si),a=s.replace(Si,"");let d=document.querySelector(a);if(d&&l){const u=`[part~="${l[1]}"]`;d=d.shadowRoot.querySelector(u)}if(!d)return;d.style.transition="none";const h=r?r[1]:null,p=getComputedStyle(d,h);n.properties.forEach(u=>{const _=p.getPropertyValue(u.propertyName)||u.defaultValue||"";e.updatePropertyValue(n.selector,u.propertyName,_)}),xi(o,n,i,!1)})}finally{try{t.cleanupElement&&await t.cleanupElement(o)}finally{o.remove()}}return e}function xi(t,e,o,i){if(e.stateAttribute){if(e.stateElementSelector){const n=De({...e,selector:e.stateElementSelector},o);t=document.querySelector(n)}t&&(i?t.setAttribute(e.stateAttribute,""):t.removeAttribute(e.stateAttribute))}}function Ci(t){return t.trim()}function Ar(t){const e=t.element;if(!e)return null;const o=e.querySelector("label");if(o&&o.textContent)return Ci(o.textContent);const i=e.textContent;return i?Ci(i):null}class Rr{constructor(){this._localClassNameMap=new Map}get stylesheet(){return this.ensureStylesheet(),this._stylesheet}add(e){this.ensureStylesheet(),this._stylesheet.replaceSync(e)}clear(){this.ensureStylesheet(),this._stylesheet.replaceSync("")}previewLocalClassName(e,o){if(!e)return;const i=this._localClassNameMap.get(e);i&&(e.classList.remove(i),e.overlayClass=null),o?(e.classList.add(o),e.overlayClass=o,this._localClassNameMap.set(e,o)):this._localClassNameMap.delete(e)}ensureStylesheet(){this._stylesheet||(this._stylesheet=new CSSStyleSheet,this._stylesheet.replaceSync(""),document.adoptedStyleSheets=[...document.adoptedStyleSheets,this._stylesheet])}}const ge=new Rr;var Y;(function(t){t.response="themeEditorResponse",t.loadComponentMetadata="themeEditorComponentMetadata",t.setLocalClassName="themeEditorLocalClassName",t.setCssRules="themeEditorRules",t.loadRules="themeEditorLoadRules",t.history="themeEditorHistory",t.openCss="themeEditorOpenCss",t.markAsUsed="themeEditorMarkAsUsed"})(Y||(Y={}));var po;(function(t){t.ok="ok",t.error="error"})(po||(po={}));class Nr{constructor(e){this.pendingRequests={},this.requestCounter=0,this.wrappedConnection=e;const o=this.wrappedConnection.onMessage;this.wrappedConnection.onMessage=i=>{i.command===Y.response?this.handleResponse(i.data):o.call(this.wrappedConnection,i)}}sendRequest(e,o){const i=(this.requestCounter++).toString(),n=o.uiId??this.getGlobalUiId();return new Promise((s,r)=>{this.wrappedConnection.send(e,{...o,requestId:i,uiId:n}),this.pendingRequests[i]={resolve:s,reject:r}})}handleResponse(e){const o=this.pendingRequests[e.requestId];if(!o){console.warn("Received response for unknown request");return}delete this.pendingRequests[e.requestId],e.code===po.ok?o.resolve(e):o.reject(e)}loadComponentMetadata(e){return this.sendRequest(Y.loadComponentMetadata,{nodeId:e.nodeId})}setLocalClassName(e,o){return this.sendRequest(Y.setLocalClassName,{nodeId:e.nodeId,className:o})}setCssRules(e){return this.sendRequest(Y.setCssRules,{rules:e})}loadRules(e){return this.sendRequest(Y.loadRules,{selectors:e})}markAsUsed(){return this.sendRequest(Y.markAsUsed,{})}undo(e){return this.sendRequest(Y.history,{undo:e})}redo(e){return this.sendRequest(Y.history,{redo:e})}openCss(e){return this.sendRequest(Y.openCss,{selector:e})}getGlobalUiId(){if(this.globalUiId===void 0){const e=window.Vaadin;if(e&&e.Flow){const{clients:o}=e.Flow,i=Object.keys(o);for(const n of i){const s=o[n];if(s.getNodeId){this.globalUiId=s.getUIId();break}}}}return this.globalUiId??-1}}const M={index:-1,entries:[]};class Ir{constructor(e){this.api=e}get allowUndo(){return M.index>=0}get allowRedo(){return M.index<M.entries.length-1}get allowedActions(){return{allowUndo:this.allowUndo,allowRedo:this.allowRedo}}push(e,o,i){const n={requestId:e,execute:o,rollback:i};if(M.index++,M.entries=M.entries.slice(0,M.index),M.entries.push(n),o)try{o()}catch(s){console.error("Execute history entry failed",s)}return this.allowedActions}async undo(){if(!this.allowUndo)return this.allowedActions;const e=M.entries[M.index];M.index--;try{await this.api.undo(e.requestId),e.rollback&&e.rollback()}catch(o){console.error("Undo failed",o)}return this.allowedActions}async redo(){if(!this.allowRedo)return this.allowedActions;M.index++;const e=M.entries[M.index];try{await this.api.redo(e.requestId),e.execute&&e.execute()}catch(o){console.error("Redo failed",o)}return this.allowedActions}static clear(){M.entries=[],M.index=-1}}class Pr extends CustomEvent{constructor(e,o,i){super("theme-property-value-change",{bubbles:!0,composed:!0,detail:{element:e,property:o,value:i}})}}class W extends N{constructor(){super(...arguments),this.value=""}static get styles(){return[gn,$`
    ...
    `}handleInputChange(t){const e=t.target;this.dispatchEvent(new ki(e.value))}handleClearClick(){this.dispatchEvent(new ki(""))}};v([b({})],Rt.prototype,"value",void 0);v([b({})],Rt.prototype,"showClearButton",void 0);Rt=v([D("vaadin-dev-tools-theme-text-input")],Rt);class Or extends CustomEvent{constructor(e){super("class-name-change",{detail:{value:e}})}}let Xe=class extends N{constructor(){super(...arguments),this.editedClassName="",this.invalid=!1}static get styles(){return[gn,$`
        .editor-row {
          padding-top: 0;
        }
    ...
    </div>`}handleInputChange(t){this.editedClassName=t.detail.value;const e=/^-?[_a-zA-Z]+[_a-zA-Z0-9-]*$/;this.invalid=!this.editedClassName.match(e),!this.invalid&&this.editedClassName!==this.className&&this.dispatchEvent(new Or(this.editedClassName))}};v([b({})],Xe.prototype,"className",void 0);v([I()],Xe.prototype,"editedClassName",void 0);v([I()],Xe.prototype,"invalid",void 0);Xe=v([D("vaadin-dev-tools-theme-class-name-editor")],Xe);class Lr extends CustomEvent{constructor(e){super("scope-change",{detail:{value:e}})}}ko($`
...
`);let Qe=class extends N{constructor(){super(...arguments),this.value=P.local}static get styles(){return $`
    ...
    ></vaadin-select>`}selectRenderer(t){var e;const o=((e=this.metadata)==null?void 0:e.displayName)||"Component",i=`${o}s`;be(y`
      ...
      `,t)}handleValueChange(t){const e=t.detail.value;e!==this.value&&this.dispatchEvent(new Lr(e))}};v([b({})],Qe.prototype,"value",void 0);v([b({})],Qe.prototype,"metadata",void 0);v([tt("vaadin-select")],Qe.prototype,"select",void 0);Qe=v([D("vaadin-dev-tools-theme-scope-selector")],Qe);let Ti=class extends W{static get styles(){return[W.styles,$`
        .editor-row {
          align-items: center;
        }
      `]}handleInputChange(t){const e=t.target.checked?this.propertyMetadata.checkedValue:"";this.dispatchChange(e||"")}renderEditor(){const t=this.value===this.propertyMetadata.checkedValue;return y` <input type="checkbox" .checked=${t} @change=${this.handleInputChange} /> `}};Ti=v([D("vaadin-dev-tools-theme-checkbox-property-editor")],Ti);let $i=class extends W{handleInputChange(t){this.dispatchChange(t.detail.value)}renderEditor(){var t;return y`
      <vaadin-dev-tools-theme-text-input
        .value=${this.value}
        .showClearButton=${((t=this.propertyValue)==null?void 0:t.modified)||!1}
        @change=${this.handleInputChange}
      ></vaadin-dev-tools-theme-text-input>
    `}};$i=v([D("vaadin-dev-tools-theme-text-property-editor")],$i);let Nt=class extends W{constructor(){super(...arguments),this.selectedPresetIndex=-1,this.presets=new At}static get styles(){return[W.styles,$`
        :host {
          --preset-count: 3;
          --slider-bg: #fff;
          --slider-border: #333;
...
`;let Ze=class extends N{constructor(){super(...arguments),this.commitValue=!1}static get styles(){return[bn,$`
        #toggle {
          display: block;
        }
    ...
    ></button>`}open(){this.commitValue=!1,this.overlay.opened=!0,this.overlay.style.zIndex="1000000";const t=this.overlay.shadowRoot.querySelector('[part="overlay"]');t.style.background="#333"}renderOverlayContent(t){const e=getComputedStyle(this.toggle,"::after").getPropertyValue("background-color");be(y` <div>
        ...
        ></vaadin-dev-tools-color-picker-overlay-content>
      </div>`,t)}handleColorChange(t){this.commitValue=!0,this.dispatchEvent(new ia(t.detail.value)),t.detail.close&&(this.overlay.opened=!1,this.handleOverlayClose())}handleOverlayEscape(){this.commitValue=!1}handleOverlayClose(){const t=this.commitValue?"color-picker-commit":"color-picker-cancel";this.dispatchEvent(new CustomEvent(t))}};v([b({})],Ze.prototype,"value",void 0);v([b({})],Ze.prototype,"presets",void 0);v([tt("#toggle")],Ze.prototype,"toggle",void 0);Ze=v([D("vaadin-dev-tools-color-picker")],Ze);let Ot=class extends N{static get styles(){return[bn,$`
        :host {
          display: block;
          padding: 12px;
        }
      ...
      ></button>`);return y` <div class="swatches">${t}</div>`}handlePickerChange(t){this.dispatchEvent(new CustomEvent("color-changed",{detail:{value:t.detail.value}}))}selectPreset(t){this.dispatchEvent(new CustomEvent("color-changed",{detail:{value:t,close:!0}}))}};v([b({})],Ot.prototype,"value",void 0);v([b({})],Ot.prototype,"presets",void 0);Ot=v([D("vaadin-dev-tools-color-picker-overlay-content")],Ot);customElements.whenDefined("vaadin-overlay").then(()=>{const t=customElements.get("vaadin-overlay");class e extends oa(t){}customElements.define("vaadin-dev-tools-color-picker-overlay",e)});customElements.define("vaadin-dev-tools-rgba-string-color-picker",ea);let Oi=class extends W{constructor(){super(...arguments),this.presets=new At}static get styles(){return[W.styles,$`
        .editor-row {
          align-items: center;
        }
    ...
    `}handleOpenCss(t){this.dispatchEvent(new na(t))}renderPropertyEditor(t,e){let o;switch(e.editorType){case R.checkbox:o=ct`vaadin-dev-tools-theme-checkbox-property-editor`;break;case R.range:o=ct`vaadin-dev-tools-theme-range-property-editor`;break;case R.color:o=ct`vaadin-dev-tools-theme-color-property-editor`;break;default:o=ct`vaadin-dev-tools-theme-text-property-editor`}return sr` <${o}
        ...
        >
        </${o}>`}};v([b({})],Lt.prototype,"metadata",void 0);v([b({})],Lt.prototype,"theme",void 0);Lt=v([D("vaadin-dev-tools-theme-property-list")],Lt);let Mt=class extends N{render(){return y`<div
      tabindex="-1"
    ...
    `];Mt=v([D("vaadin-dev-tools-shim")],Mt);const sa={resolve:t=>he(e=>e.classList.contains("cc-banner"),t)?document.querySelector("vaadin-cookie-consent"):void 0},ra={resolve:t=>{const e=he(o=>o.localName==="vaadin-login-overlay-wrapper",t);return e?e.__dataHost:void 0}},aa={resolve:t=>t.localName==="vaadin-dialog-overlay"?t.__dataHost:void 0},la={resolve:t=>{const e=he(o=>o.localName==="vaadin-confirm-dialog-overlay",t);return e?e.__dataHost:void 0}},da={resolve:t=>{const e=he(o=>o.localName==="vaadin-notification-card",t);return e?e.__dataHost:void 0}},ca={resolve:t=>t.localName!=="vaadin-menu-bar-item"?void 0:he(e=>e.localName==="vaadin-menu-bar",t)},Li=[sa,ra,aa,la,da,ca],ha={resolve:t=>he(e=>e.classList.contains("cc-banner"),t)},ua={resolve:t=>{var e;const o=he(i=>{var n;return((n=i.shadowRoot)==null?void 0:n.querySelector("[part=overlay]"))!=null},t);return(e=o==null?void 0:o.shadowRoot)==null?void 0:e.querySelector("[part=overlay]")}},pa={resolve:t=>{var e;const o=he(i=>i.localName==="vaadin-login-overlay-wrapper",t);return(e=o==null?void 0:o.shadowRoot)==null?void 0:e.querySelector("[part=card]")}},Mi=[pa,ha,ua],he=function(t,e){return t(e)?e:e.parentNode&&e.parentNode instanceof HTMLElement?he(t,e.parentNode):void 0};class ma{resolveElement(e){for(const o in Li){let i=e;if((i=Li[o].resolve(e))!==void 0)return i}return e}}class va{resolveElement(e){for(const o in Mi){let i=e;if((i=Mi[o].resolve(e))!==void 0)return i}return e}}const fa=new ma,ga=new va;let ve=class extends N{constructor(){super(),this.active=!1,this.components=[],this.selected=0,this.mouseMoveEvent=this.mouseMoveEvent.bind(this)}connectedCallback(){super.connectedCallback();const t=new CSSStyleSheet;t.replaceSync(`
...
`)+o.textContent.trim()).join("").replace(/^\n/,"");Ta(e),this._devTools.showNotification(z.INFORMATION,"Environment information copied to clipboard",void 0,void 0,"versionInfoCopied")}};v([b({type:Object})],Vt.prototype,"_devTools",void 0);v([I()],Vt.prototype,"serverInfo",void 0);Vt=v([D("vaadin-dev-tools-info")],Vt);let fo=class extends N{createRenderRoot(){return this}activate(){this._devTools.unreadErrors=!1,this.updateComplete.then(()=>{const t=this.renderRoot.querySelector(".message-tray .message:last-child");t&&t.scrollIntoView()})}render(){return y`<div class="message-tray">
    ...
    `}render(){return y` <div
      ...
      >
        ...
        ></span>
        ${this.splashMessage?y`<span class="status-description">${this.splashMessage}</span></div>`:T}
...
function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["./vaadin-big-decimal-field-e51def24-mvy51Ymq.js","./vaadin-text-field-0b3db014-TCZvnJBc.js","./vaadin-button-2511ad84-CQ5821-N.js","./vaadin-checkbox-group-a7c65bf2-C05Xe8e2.js","./vaadin-checkbox-4e68df64-WVIB0toL.js","./vaadin-combo-box-96451ddd-DM6r5sSv.js","./vaadin-confirm-dialog-4d718829-CeFPjh4r.js","./vaadin-custom-field-42c85b9e-8iGUX0O6.js","./vaadin-date-picker-f2001167-je0DJggy.js","./vaadin-date-time-picker-c8c047a7-DdQlphR0.js","./vaadin-email-field-d7a35f04-DBXspmES.js","./vaadin-grid-pro-ff415555-Bj_OySHI.js","./vaadin-grid-0a4791c2-BPtWQPgX.js","./vaadin-integer-field-85078932-hyvYYhAw.js","./vaadin-login-form-638996c6-CP8E1oJC.js","./vaadin-login-overlay-f8a5db8a-CCQENCMU.js","./vaadin-message-input-996ac37c-BWmDJtzc.js","./vaadin-multi-select-combo-box-a3373557-GeAJ42UB.js","./vaadin-number-field-cb3ee8b2-CTcI_Hw_.js","./vaadin-password-field-d289cb18-Cx4-q7Z-.js","./vaadin-radio-group-88b5afd8-2zGHKwCw.js","./vaadin-select-df6e9947-DVebgvGD.js","./vaadin-text-area-83627ebc-D5ec7Pyq.js","./vaadin-time-picker-715ec415-CvFhJHLz.js","./vaadin-upload-d3c162ed-MoZKNrcP.js"]
  }
